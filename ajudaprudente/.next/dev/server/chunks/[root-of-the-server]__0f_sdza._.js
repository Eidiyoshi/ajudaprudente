...
function isValidPayload(payload) {
    ...
    return typeof body.nome === "string" && body.nome.trim().length > 0 && typeof body.email === "string" && body.email.trim().length > 0 && typeof body.senha === "string" && body.senha.trim().length > 0 && typeof body.telefone === "number" && Number.isFinite(body.telefone) && typeof body.cnpj === "number" && Number.isFinite(body.cnpj) && typeof endereco === "object" && endereco !== null && typeof endereco.cidade === "string" && endereco.cidade.trim().length > 0 && typeof endereco.bairro === "string" && endereco.bairro.trim().length > 0 && typeof endereco.rua === "number" && Number.isInteger(endereco.rua) && typeof endereco.cep === "string" && endereco.cep.trim().length > 0 && (endereco.apartamento === undefined || typeof endereco.apartamento === "string") && (endereco.numero === undefined || typeof endereco.numero === "string");
}
...
//# sourceMappingURL=%5Broot-of-the-server%5D__0f_sdza._.js.map