...
"[project]/ajudaPrudente/ajudaprudente/app/lib/Endereco.ts [app-route] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
class Endereco {
    ...
    apartamento;
    numero;
    constructor(cidade, bairro, rua, cep, apartamento, numero){
        this.cidade = cidade;
        this.bairro = bairro;
        this.rua = rua;
        this.cep = cep;
    ...
    async storeOnDb() {
        if (this.idEndereco === undefined) {
            const lastEndereco = await __TURBOPACK__imported__module__$5b$project$5d2f$ajudaPrudente$2f$ajudaprudente$2f$lib$2f$prisma$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["prisma"].endere_o.findFirst({
                select: {
                    idendere_o: true
                },
                orderBy: {
        ...
        const created = await __TURBOPACK__imported__module__$5b$project$5d2f$ajudaPrudente$2f$ajudaprudente$2f$lib$2f$prisma$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["prisma"].endere_o.create({
            data: {
...
"[project]/ajudaPrudente/ajudaprudente/app/lib/Voluntario.ts [app-route] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
;
;
class Voluntario extends __TURBOPACK__imported__module__$5b$project$5d2f$ajudaPrudente$2f$ajudaprudente$2f$app$2f$lib$2f$Usuario$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["Usuario"] {
    idusuarios;
    nome;
    email;
    senha;
    ...
    rg;
    cpf;
    constructor(nome, email, senha, telefone, tipoUsuario, rg, cpf){
    ...
    async storeOnDb(endereco) {
        if (this.idusuarios === undefined) {
            const lastVoluntario = await __TURBOPACK__imported__module__$5b$project$5d2f$ajudaPrudente$2f$ajudaprudente$2f$lib$2f$prisma$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["prisma"].voluntario.findFirst({
                select: {
                    idusuarios: true
                },
                orderBy: {
        ...
        const created = await __TURBOPACK__imported__module__$5b$project$5d2f$ajudaPrudente$2f$ajudaprudente$2f$lib$2f$prisma$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["prisma"].voluntario.create({
            data: {
...
"[project]/ajudaPrudente/ajudaprudente/app/api/voluntario/route.ts [app-route] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
var __TURBOPACK__imported__module__$5b$project$5d2f$ajudaPrudente$2f$ajudaprudente$2f$app$2f$lib$2f$Endereco$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/ajudaPrudente/ajudaprudente/app/lib/Endereco.ts [app-route] (ecmascript)");
...
var __TURBOPACK__imported__module__$5b$project$5d2f$ajudaPrudente$2f$ajudaprudente$2f$app$2f$lib$2f$Voluntario$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/ajudaPrudente/ajudaprudente/app/lib/Voluntario.ts [app-route] (ecmascript)");
;
;
;
function isValidPayload(payload) {
    ...
    return typeof body.nome === "string" && body.nome.trim().length > 0 && typeof body.email === "string" && body.email.trim().length > 0 && typeof body.senha === "string" && body.senha.trim().length > 0 && typeof body.telefone === "number" && Number.isFinite(body.telefone) && typeof body.rg === "string" && body.rg.trim().length > 0 && typeof body.cpf === "string" && body.cpf.trim().length > 0 && typeof endereco === "object" && endereco !== null && typeof endereco.cidade === "string" && endereco.cidade.trim().length > 0 && typeof endereco.bairro === "string" && endereco.bairro.trim().length > 0 && typeof endereco.rua === "number" && Number.isInteger(endereco.rua) && typeof endereco.cep === "string" && endereco.cep.trim().length > 0 && (endereco.apartamento === undefined || typeof endereco.apartamento === "string") && (endereco.numero === undefined || typeof endereco.numero === "string");
}
async function POST(request) {
    ...
    const voluntario = new __TURBOPACK__imported__module__$5b$project$5d2f$ajudaPrudente$2f$ajudaprudente$2f$app$2f$lib$2f$Voluntario$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["Voluntario"](payload.nome, payload.email, payload.senha, payload.telefone, __TURBOPACK__imported__module__$5b$project$5d2f$ajudaPrudente$2f$ajudaprudente$2f$app$2f$lib$2f$TipoUsuario$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["TipoUsuario"].Voluntario, payload.rg, payload.cpf);
    const endereco = new __TURBOPACK__imported__module__$5b$project$5d2f$ajudaPrudente$2f$ajudaprudente$2f$app$2f$lib$2f$Endereco$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["Endereco"](payload.endereco.cidade, payload.endereco.bairro, payload.endereco.rua, payload.endereco.cep, payload.endereco.apartamento, payload.endereco.numero);
...
//# sourceMappingURL=%5Broot-of-the-server%5D__0~hsyb6._.js.map